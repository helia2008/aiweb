---
title: AI 筛简历实操：HR 一晚看完 800 份的初筛流水线
...
faqs:
  - q: AI 初筛会不会漏掉好简历？
    a: 会，所以不让它做终裁。最典型是专业名带括号被整批漏掉——硬性条件用“包含任一关键词”而非“完全等于”，“不看”档再抽 5 份人工反查防错杀。
  - q: 简历含个人信息，合规上有讲究吗？
    a: 有讲究。优先用本地 LLM 或自托管 Agent，别发外部 API；若必须用云端，本地保留姓名/电话/邮箱，只把提取后的字段结构发过去，不传整份 PDF。
